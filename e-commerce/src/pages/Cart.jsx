...
const Cart = () => {
	...
	useEffect(() => {
		const func = async () => {
			const products = await publicRequest.get("/cart", { withCredentials: true });
	...
	const deleteCart = async (productid) => {
		...
		await publicRequest.delete(`/cart/${checkk}`, { withCredentials: true });
				...
				<Bottom>
					...
					<Summary>
						...
						<SummaryItem>
							...
							{total >= 500 ? <SummaryItemPrice>₹ -70.00</SummaryItemPrice> : <SummaryItemPrice>₹ -0.00</SummaryItemPrice>}
						</SummaryItem>
						<SummaryItem type="total">
							<SummaryItemText>Total</SummaryItemText>
							{total >= 500 ? <SummaryItemPrice>₹ {total}</SummaryItemPrice> : <SummaryItemPrice>₹ {total + 70}</SummaryItemPrice>}
						</SummaryItem>
